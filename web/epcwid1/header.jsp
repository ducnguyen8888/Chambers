...
<head>
    <link rel="shortcut icon" href="<%= request.getContextPath() %>/epcwid1/assets/logo.png">
    ...
    #content { clear: both; margin-bottom: 140px; padding: 30px 15px 15px 15px; }
...
<header>
    <div class="container clearfix">
        <div id="logo">	
            <a href="http://www.co.chambers.tx.us/"><img alt="EPCWID #1" src="<%= request.getContextPath() %>/epcwid1/assets/chambers.png"></a>
        </div>
        <div id="menu">	
            <ul>
