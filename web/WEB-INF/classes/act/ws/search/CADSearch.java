...
public class CADSearch extends OwnerNameSearch {
    /** Empty Owner Name search object */
    public CADSearch() {
        this.searchType = SEARCH_BY_CAD | STARTS_WITH_SEARCH; 
    }
     ...
     */
    public CADSearch(String clientId, String criteria) {
        this();
     ...
     *  @param criteria the owner name search criteria
     */
    public CADSearch(String clientId, String year, String criteria) {
        this();
        this.setCriteria(clientId, criteria)
            .setYear(year);
    }

    public static CADSearch initialContext() {
        return new CADSearch();
    }
    ...
    public String getQueryString() throws Exception {
        return    "with "
                ...
                + "             ) "
                + " select /*+ index(t TAXDTL_APRDISTACC_IX) index(o OWNER_CAN_IX) */ "
                ...
                + "   and (t.aprdistacc like parameter.criteria) "
