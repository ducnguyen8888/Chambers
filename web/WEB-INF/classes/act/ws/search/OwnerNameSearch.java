...
public class OwnerNameSearch extends Search {
    /** Empty Owner Name search object */
    public OwnerNameSearch() {
        this.searchType = SEARCH_BY_OWNER_NAME | STARTS_WITH_SEARCH; 
    }
     ...
     */
    public OwnerNameSearch(String clientId, String criteria) {
        this();
     ...
     *  @param criteria the owner name search criteria
     */
    public OwnerNameSearch(String clientId, String year, String criteria) {
        this();
        this.setCriteria(clientId, criteria)
            .setYear(year);
    }

    public static OwnerNameSearch initialContext() {
        return new OwnerNameSearch();
    }
    ...
    public String getQueryString() throws Exception {
        return    "with "
                ...
                + "             ) "
                + " select /*+ index(o OWNER_NAMELINE1_IX) index(t taxdtl_pk) */ "
                ...
                + "   and (o.nameline1 like parameter.criteria) "
    ...
    protected SearchAccount[] executeSearch(Connection con) throws Exception {
        ...
        try {
            trace.setLength(0);
            trace.append((new java.util.Date()).toString() + ": Account Search - Owner Name\n");
            ...
            //if ( (searchType & SEARCH_BY_OWNER_NAME) == 0 ) throw INVALID_SEARCH_TYPE;
            //if ( (searchType & definedSearchType) == 0 ) throw INVALID_SEARCH_TYPE;
            ...
            try ( PreparedStatement ps = con.prepareStatement(query); ) {
                ...
                trace.append("client_id (" + client_id + ")  year: (" + year + ")  max records: " + maxRecords + "\n");
                ...
                if ( setQueryValues ) {
                    try {
                        query = replaceQueryParameterField(query,client_id);
                        ...
                        query = replaceQueryParameterField(query,criteria);
